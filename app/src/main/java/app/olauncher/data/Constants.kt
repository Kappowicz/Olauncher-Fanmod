...
object Constants {
    ...
    object FontFamily {
        const val SANS = 0
        const val CONDENSED = 1
        const val SERIF = 2
        const val MONO = 3
        const val INTER = 4
        const val MANROPE = 5
        const val OUTFIT = 6
        const val SPACE_GROTESK = 7
        const val LEXEND = 8
    }
...
//    const val THEME_MODE_SYSTEM = 2
    ...
    const val URL_FANMOD_GITHUB = "https://github.com/Kappowicz/Olauncher-Fanmod"
    const val URL_SUPPORT_ORIGINAL_DEVELOPER = "https://github.com/sponsors/tanujnotes"
